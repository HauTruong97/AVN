#include "AVNViewer.h"
AVNViewer::AVNViewer()
: BaseService(MQ_AVN_APP, MQ_TYPE_VIEWER)
{
...
AVNViewer::~AVNViewer()
{
    printf("AVNViewer destroyed!\n");
}
void AVNViewer::viewerRequest()
{
    MQ_MSG_T message;
...
void AVNViewer::onHandleMessage(const int msgDataId, const bool status, const PROFILE profile)
{
